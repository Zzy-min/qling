...
const TOPICS: HelpTopic[] = [
  {
    id: "model",
    title: "当前会话模型",
    summary: "查看或切换当前进程会话使用的模型。",
    aliases: ["model", "/model"],
    slashUsage: "/model [model]",
    cliUsage: "{bin} --model <model>",
    slashExamples: ["/model", "/model qwen-plus"],
    cliExamples: ["{bin} --model qwen-plus"],
    boundary: "slash 切换只影响当前进程会话；不写配置文件、不联网、不调用模型。",
  },
  {
    id: "usage",
    title: "本地用量",
  ...
  },
  {
    id: "plan",
    title: "普通会话计划",
    summary: "把描述转成下一条普通计划 prompt。",
    aliases: ["plan", "/plan"],
    slashUsage: "/plan [description]",
    cliUsage: "仅 slash：在当前交互会话中使用",
    slashExamples: ["/plan 修复认证失败"],
    cliExamples: [],
    boundary: "不进入 Codex Plan Mode；不修改文件；是否执行由后续普通会话决定。",
  },
  {
    id: "diff",
    title: "Git 变更摘要",
    summary: "只读查看当前工作区 Git status/diff 摘要。",
    aliases: ["diff", "/diff"],
    slashUsage: "/diff",
  ...
  },
  {
    id: "rewind",
    title: "可恢复点",
    summary: "查看可恢复会话点，并提示用 /resume 恢复。",
    aliases: ["rewind", "/rewind", "undo", "/undo"],
    slashUsage: "/rewind",
    cliUsage: "{bin} sessions",
    slashExamples: ["/rewind", "/undo", "/resume session-123"],
    cliExamples: ["{bin} sessions"],
    boundary: "不自动回滚代码、不修改文件；只读取本地会话摘要。",
  },
  {
    id: "exports",
    title: "本地导出列表",
