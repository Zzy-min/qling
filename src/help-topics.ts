...
const TOPICS: HelpTopic[] = [
  ...
  {
    id: "plan",
    title: "Plan Mode（只读规划）",
    summary: "进入/退出只读 Plan Mode，或排队规划 prompt；禁 write/patch/bash 等写工具。",
    aliases: ["plan", "/plan"],
    slashUsage: "/plan [on|off|status|description]",
    cliUsage: "仅 slash：在当前交互会话中使用",
    slashExamples: ["/plan on", "/plan off", "/plan status", "/plan 修复认证失败"],
    cliExamples: [],
