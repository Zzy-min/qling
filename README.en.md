...
| npm `@qlingzzy/qling` | **Published** `1.2.1` — install with `--registry https://registry.npmjs.org/` if your default is a mirror |
...
- Package: `1.2.1` (see latest tag on GitHub for hotfixes)
