...
| npm `@qlingzzy/qling` | **Published** `1.3.0` — install with `--registry https://registry.npmjs.org/` if your default is a mirror |
...
- Source package: `1.3.1` (see the latest GitHub tag for the published release)
